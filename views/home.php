...
<head>
    ...
    <script defer src="/js/testimonialSwiper.js"></script>
</head>
    ...
    <main>
        <section class="home-hero">
            ...
            <div class="home-hero__content">
                <div>
                    <img src="assets/images/logo/Logo_macaco3.png" alt="logo">
                    <img src="assets/images/logo/Logo-dourado.png" alt="">
                </div>
            </div>
            <div class="home-hero__scroll">
                <svg x="0px" y="0px" viewBox="0 0 76.45 34.69">
                    <path d="M11.23,21.94c-1.47,0.35-1.54,1.7-1.49,2.75c0.01,0.19,0.06,0.37,0.13,0.54c0.46,1.11,2.31,1.14,3.08,0.62
                C14.54,24.77,13.83,21.32,11.23,21.94z" fill="currentColor"></path>
        ...
        <section class="home-menu">
            ...
            <div class="home-menu__container">
                <nav class="home-menu__nav">
                    <ul class="home-menu__nav-ul">
                        ...
                        <li><button class="home-menu__li" data-category="snacks">Food</button></li>
                    </ul>
                </nav>
            ...
            <div>
                <a class="btn2" href="<?= ROOT ?>/menu">See the full menu</a>
            </div>
        </section>
        <section class="home-details">
            <div class="home-details__container">
                <div class="home-details__general">
                    <h3>General Information</h3>
                    <div class="home-details__general-content">
                        <h4>Bar Concept</h4>
                ...
                <div class="home-details__happy-hour">
                    <h3>Happy Hour!</h3>
                    <div class="home-details__happy-content">
                        <h4>40% off all cocktails</h4>
                        <div class="home-details__date">
                            <span>Wed, Thu, Sun</span>
                            <span>19:00 - 21:00</span>
                        </div>
                        <div class="home-details__disclaimer">
        ...
        <section class="home-testimonials">
            <div class="home-testimonials__container">
                ...
                <div class="home-testimonials__swiper swiper">
                    <div class="home-testimonials__swiper-wrapper swiper-wrapper">
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            <h4 class="home-testimonials__h4">Diogo Costa</h4>
                            <div class="home-testimonials__stars">
                            ...
                            <p class="home-testimonials__text">I had really high expectations for this place, due to all the reviews I received. It surpassed my expectations, amazing cocktails and Mauro is able to suggest cocktails based on our preferences. Additionally it has the best fries I had tried in a bar. Totally recommend everyone to try it out!</p>
                        </div>
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            <h4 class="home-testimonials__h4">Diogo Costa</h4>
                            <div class="home-testimonials__stars">
                        ...
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            ...
                            <p class="home-testimonials__text">I had really high expectations for this place, due to all the reviews I received. It surpassed my expectations, amazing cocktails and Mauro is able to suggest cocktails based on our preferences. Additionally it has the best fries I had tried in a bar. Totally recommend everyone to try it out! Lorem ipsum dolor sit amet consectetur.</p>
                        </div>
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            <h4 class="home-testimonials__h4">Diogo Costa</h4>
                            <div class="home-testimonials__stars">
                            ...
                            <p class="home-testimonials__text">I had really high expectations for this place, due to all the reviews I received. It surpassed my expectations, amazing cocktails and Mauro is able to suggest cocktails based on our preferences. Additionally it has the best fries I had tried in a bar. Totally recommend everyone to try it out! Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque nihil est dicta neque expedita alias sit minus magni nemo aut.</p>
                        </div>
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            <h4 class="home-testimonials__h4">Diogo Costa</h4>
                            <div class="home-testimonials__stars">
                        ...
                        <div class="home-testimonials__swiper-slide swiper-slide">
                            ...
                            <p class="home-testimonials__text">I had really high expectations for this place, due to all the reviews I received. It surpassed my expectations, amazing cocktails and Mauro is able to suggest cocktails based on our preferences. Additionally it has the best fries I had tried in a bar. Totally recommend everyone to try it out! Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, distinctio!</p>
                        </div>
                    </div>
                    <div class="home-testimonials__nav">

                        <div class="home-testimonials__btn swiper-button-prev"></div>
                        <div class="home-testimonials__pagination swiper-pagination"></div>
                        <div class="home-testimonials__btn swiper-button-next"></div>
                    </div>
                </div>
            </div>
        </section>
        <section class="home-info">
            <div class="home-info__container">
                <div class="home-info__content">
                    <div class="home-info__address">
                        <h3>Visit Us</h3>
                        <p>Rua Machado dos Santos, nº31
                            2410-128, Leiria, Portugal</p>
                    </div>
                    <div class="home-info__schedule">
                        <h3>Schedule</h3>
                        <div class="home-info__time">
                            <span>Sun, Mon, Tue, Wed, Thu</span>
                ...
                <div class="home-info__map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3067.2850722185512!2d-8.811270055641442!3d39.74358216621025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd2273158a739a01%3A0xd98bad3693c2842c!2sThe%20Monkey%20Business%20Bar!5e0!3m2!1spt-PT!2spt!4v1748515303840!5m2!1spt-PT!2spt" style="border:0;" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </section>
    </main>
